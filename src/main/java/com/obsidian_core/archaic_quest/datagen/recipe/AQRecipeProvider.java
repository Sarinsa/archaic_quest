...
public class AQRecipeProvider extends AbstractRecipeProvider {
    ...
    public AQRecipeProvider( PackOutput packOutput ) {
        super( packOutput );
    }
    ...
    public void buildRecipes( Consumer<FinishedRecipe> consumer ) {
        ...
        this.smelting( RecipeCategory.MISC, AQItems.TIN_INGOT.get(), AQBlocks.TIN_ORE.get(), 0.7F, consumer );
        this.smelting( RecipeCategory.MISC, AQItems.SILVER_INGOT.get(), AQBlocks.SILVER_ORE.get(), 0.7F, consumer );
        this.smelting( RecipeCategory.MISC, Items.QUARTZ, AQBlocks.GRANITE_QUARTZ_ORE.get(), 0.2F, consumer );
        this.smelting( RecipeCategory.MISC, AQItems.JADE.get(), AQBlocks.DIORITE_JADE_ORE.get(), 1.0F, consumer );
        this.smelting( RecipeCategory.MISC, AQItems.TURQUOISE.get(), AQBlocks.ANDESITE_TURQUOISE_ORE.get(), 1.0F, consumer );
        ...
        ShapedRecipeBuilder.shaped( RecipeCategory.DECORATIONS, AQBlocks.ANDESITE_BRICKS.get(), 4 )
                .pattern( "##" )
                .pattern( "##" )
        ...
        ShapelessRecipeBuilder.shapeless( RecipeCategory.REDSTONE, AQBlocks.ANDESITE_AZTEC_TRAP_0.get(), 1 )
