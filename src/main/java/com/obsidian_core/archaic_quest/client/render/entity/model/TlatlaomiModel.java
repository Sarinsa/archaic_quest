...
public class TlatlaomiModel extends EntityModel<Tlatlaomi> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition tlatlaomi = root.addOrReplaceChild( "tlatlaomi", CubeListBuilder.create().texOffs( 0, 0 ).addBox( -5.0F, -2.0F, 0.0F, 10.0F, 8.0F, 5.0F, new CubeDeformation( 0.0F ) )
        ...
        tlatlaomi.addOrReplaceChild( "innerTendons02_r1", CubeListBuilder.create().texOffs( 112, 24 ).addBox( 0.25F, -2.0F, -5.0F, 0.0F, 13.0F, 7.0F, new CubeDeformation( 0.0F ) ), PartPose.offsetAndRotation( 0.0F, 0.0F, 3.0F, 0.0F, -1.0908F, 0.0F ) );
        tlatlaomi.addOrReplaceChild( "innerTendons01_r1", CubeListBuilder.create().texOffs( 97, 24 ).addBox( -0.25F, -2.0F, -5.0F, 0.0F, 13.0F, 7.0F, new CubeDeformation( 0.0F ) ), PartPose.offsetAndRotation( 0.0F, 0.0F, 3.0F, 0.0F, 1.0908F, 0.0F ) );
        ...
        cape.addOrReplaceChild( "capeLower", CubeListBuilder.create().texOffs( 105, 62 ).addBox( -5.0F, 0.0F, -0.75F, 10.0F, 3.0F, 1.0F, new CubeDeformation( 0.0F ) ), PartPose.offset( 0.0F, 16.0F, 0.0F ) );
        ...
        loinclothFront.addOrReplaceChild( "cube_r1", CubeListBuilder.create().texOffs( 18, 35 ).addBox( -4.0F, -1.0F, -0.75F, 8.0F, 7.0F, 1.0F, new CubeDeformation( 0.0F ) ), PartPose.offsetAndRotation( 0.0F, 0.0F, 0.0F, -0.1309F, 0.0F, 0.0F ) );
        
        belt.addOrReplaceChild( "loinclothBack", CubeListBuilder.create().texOffs( 19, 44 ).addBox( -4.0F, 0.0F, 0.5F, 8.0F, 7.0F, 1.0F, new CubeDeformation( 0.0F ) ), PartPose.offsetAndRotation( 0.0F, 0.0F, 0.0F, 0.0873F, 0.0F, 0.0F ) );
        ...
        lLeg01.addOrReplaceChild( "lLeg02", CubeListBuilder.create().texOffs( 0, 49 ).addBox( -1.5F, -0.01F, -0.25F, 3.0F, 9.0F, 4.0F, new CubeDeformation( 0.0F ) ), PartPose.offset( 0.0F, 9.0F, -1.75F ) );
        ...
        rLeg01.addOrReplaceChild( "rLeg02", CubeListBuilder.create().texOffs( 0, 49 ).mirror().addBox( -1.5F, -0.01F, -0.25F, 3.0F, 9.0F, 4.0F, new CubeDeformation( 0.0F ) ).mirror( false ), PartPose.offset( 0.0F, 9.0F, -1.75F ) );
        ...
        lFeather01.addOrReplaceChild( "cube_r2", CubeListBuilder.create().texOffs( 56, 23 ).addBox( 0.0F, -13.0F, -2.0F, 0.0F, 13.0F, 4.0F, new CubeDeformation( 0.0F ) ), PartPose.offsetAndRotation( 0.0F, 0.0F, 0.0F, 0.0F, 0.5672F, 0.0F ) );
        ...
        lFeather02.addOrReplaceChild( "cube_r3", CubeListBuilder.create().texOffs( 47, 23 ).addBox( 0.0F, -13.0F, -2.0F, 0.0F, 13.0F, 4.0F, new CubeDeformation( 0.0F ) ), PartPose.offsetAndRotation( 0.0F, 0.0F, 0.0F, 0.0F, 0.48F, 0.0F ) );
        ...
        lFeather03.addOrReplaceChild( "cube_r4", CubeListBuilder.create().texOffs( 38, 23 ).addBox( 0.0F, -13.0F, -2.0F, 0.0F, 13.0F, 4.0F, new CubeDeformation( 0.0F ) ), PartPose.offsetAndRotation( 0.0F, 0.0F, 0.0F, 0.0F, 0.5672F, 0.0F ) );
        ...
        lFeather04.addOrReplaceChild( "cube_r5", CubeListBuilder.create().texOffs( 41, 27 ).addBox( 1.0F, -3.0F, -2.0F, 0.0F, 5.0F, 13.0F, new CubeDeformation( 0.0F ) ), PartPose.offsetAndRotation( 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.2618F ) );
        ...
        rFeather01.addOrReplaceChild( "cube_r6", CubeListBuilder.create().texOffs( 56, 23 ).mirror().addBox( 0.0F, -13.0F, -2.0F, 0.0F, 13.0F, 4.0F, new CubeDeformation( 0.0F ) ).mirror( false ), PartPose.offsetAndRotation( 0.0F, 0.0F, 0.0F, 0.0F, -0.5672F, 0.0F ) );
        ...
        rFeather02.addOrReplaceChild( "cube_r7", CubeListBuilder.create().texOffs( 47, 23 ).mirror().addBox( 0.0F, -13.0F, -2.0F, 0.0F, 13.0F, 4.0F, new CubeDeformation( 0.0F ) ).mirror( false ), PartPose.offsetAndRotation( 0.0F, 0.0F, 0.0F, 0.0F, -0.48F, 0.0F ) );
        ...
        rFeather03.addOrReplaceChild( "cube_r8", CubeListBuilder.create().texOffs( 38, 23 ).mirror().addBox( 0.0F, -13.0F, -2.0F, 0.0F, 13.0F, 4.0F, new CubeDeformation( 0.0F ) ).mirror( false ), PartPose.offsetAndRotation( 0.0F, 0.0F, 0.0F, 0.0F, -0.5672F, 0.0F ) );
        ...
        rFeather04.addOrReplaceChild( "cube_r9", CubeListBuilder.create().texOffs( 41, 27 ).mirror().addBox( -1.0F, -3.0F, -2.0F, 0.0F, 5.0F, 13.0F, new CubeDeformation( 0.0F ) ).mirror( false ), PartPose.offsetAndRotation( 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.2618F ) );
        ...
        headdresstassle.addOrReplaceChild( "tassleFeather01", CubeListBuilder.create().texOffs( 0, 75 ).addBox( 0.0F, -1.0F, 0.0F, 0.0F, 4.0F, 14.0F, new CubeDeformation( 0.0F ) ), PartPose.offsetAndRotation( 0.0F, -2.0F, 11.0F, 0.0873F, 0.0F, 0.0F ) );
        headdresstassle.addOrReplaceChild( "tassleFeather02", CubeListBuilder.create().texOffs( 0, 80 ).addBox( 0.25F, -1.0F, 0.0F, 0.0F, 4.0F, 14.0F, new CubeDeformation( 0.0F ) ), PartPose.offsetAndRotation( 0.0F, 0.0F, 11.0F, -0.0436F, 0.0F, 0.0F ) );
        headdresstassle.addOrReplaceChild( "tassleFeather03", CubeListBuilder.create().texOffs( 0, 85 ).addBox( 0.0F, -2.0F, 0.0F, 0.0F, 4.0F, 14.0F, new CubeDeformation( 0.0F ) ), PartPose.offsetAndRotation( 0.0F, 1.5F, 11.0F, -0.3491F, 0.0F, 0.0F ) );
        headdresstassle.addOrReplaceChild( "tassleFeather2", CubeListBuilder.create().texOffs( 0, 75 ).addBox( -0.25F, -1.0F, 0.0F, 0.0F, 4.0F, 14.0F, new CubeDeformation( 0.0F ) ), PartPose.offsetAndRotation( 0.0F, 3.0F, 11.0F, -0.48F, 0.0F, 0.0F ) );
        
        headpiece.addOrReplaceChild( "headdress_tail", CubeListBuilder.create().texOffs( 70, 30 ).addBox( -2.0F, 0.0F, -1.0F, 4.0F, 9.0F, 2.0F, new CubeDeformation( 0.0F ) ), PartPose.offsetAndRotation( 0.0F, 6.0F, 4.0F, 0.1745F, 0.0F, 0.0F ) );
        
        head.addOrReplaceChild( "lowerJaw", CubeListBuilder.create().texOffs( 38, 19 ).addBox( -3.0F, -0.1736F, -5.9848F, 6.0F, 2.0F, 6.0F, new CubeDeformation( 0.0F ) ), PartPose.offsetAndRotation( 0.0F, -1.8644F, -0.2152F, 0.1745F, 0.0F, 0.0F ) );
        ...
        lArm01.addOrReplaceChild( "lArm02", CubeListBuilder.create().texOffs( 55, 46 ).addBox( -1.5F, -0.01F, -1.5F, 3.0F, 9.0F, 3.0F, new CubeDeformation( 0.0F ) )
        ...
        rArm01.addOrReplaceChild( "rArm02", CubeListBuilder.create().texOffs( 55, 46 ).mirror().addBox( -1.5F, -0.01F, -1.5F, 3.0F, 9.0F, 3.0F, new CubeDeformation( 0.0F ) ).mirror( false )
