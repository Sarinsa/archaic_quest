...
public class ClientRegister {
    ...
    public static void registerParticleFactories( RegisterParticleProvidersEvent event ) {
        event.registerSpriteSet( AQParticles.POISON_CLOUD.get(), PoisonCloudParticle.Factory::new );
    }
    ...
    public static void registerLayerDefs( EntityRenderersEvent.RegisterLayerDefinitions event ) {
        ...
        for( AQBoat.BoatType type : AQBoat.BoatType.values() ) {
            event.registerLayerDefinition( AQBoatRenderer.createBoatModelName( type ), BoatModel::createBodyModel );
            event.registerLayerDefinition( AQBoatRenderer.createChestBoatModelName( type ), ChestBoatModel::createBodyModel );
        }
    }
