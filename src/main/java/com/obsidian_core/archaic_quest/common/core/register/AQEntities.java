...
public class AQEntities {
    ...
    // PROJECTILE
    public static final RegistryObject<EntityType<BaseDartEntity>> DART = register( "dart", () -> EntityType.Builder.<BaseDartEntity>of( BaseDartEntity::new, MobCategory.MISC )
            .sized( 0.2F, 0.2F )
