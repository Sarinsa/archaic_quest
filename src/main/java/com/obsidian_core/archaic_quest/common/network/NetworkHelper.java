...
public class NetworkHelper {
    ...
    public static void updateSpikeTrap( ServerLevel world, BlockPos pos, SpikeTrapBlock.SpikeMode spikeMode ) {
        for( ServerPlayer player : world.players() ) {
            PacketHandler.sendToClient( new S2CUpdateSpikeTrapMode( pos, spikeMode.ordinal() ), player );
        }
    }
}
