...
import static com.obsidian_core.archaic_quest.common.block.SpikeTrapBlock.SpikeMode;
...
public class SpikeTrapBlockEntity extends BlockEntity {
    ...
    private SpikeMode spikeMode = SpikeMode.NORMAL;
    ...
    public static void tick( Level level, BlockPos pos, BlockState state, SpikeTrapBlockEntity trap ) {
        ...
        if( trap.active ) {
            ...
            for( LivingEntity entity : entities ) {
                entity.hurt( AQDamageTypes.of( level, AQDamageTypes.SPIKE_TRAP ), 2.0F );
    ...
    public void setMode( SpikeMode spikeMode ) {
        this.spikeMode = spikeMode;
    }
    
    public SpikeMode getMode() {
        return spikeMode;
    }
    ...
    public void load( CompoundTag compoundTag ) {
        ...
        if( compoundTag.contains( "SpikeMode", Tag.TAG_STRING ) ) {
            SpikeTrapBlock.SpikeMode spikeMode = SpikeTrapBlock.SpikeMode.getFromName( compoundTag.getString( "SpikeMode" ) );
            this.spikeMode = spikeMode == null ? SpikeMode.NORMAL : spikeMode;
        }
    }
    ...
    public void saveAdditional( CompoundTag compoundTag ) {
        ...
        compoundTag.putString( "SpikeMode", spikeMode.getSerializedName() );
    }
    ...
    public void handleUpdateTag( CompoundTag tag ) {
        ...
        if( tag.contains( "SpikeMode", Tag.TAG_STRING ) ) {
            SpikeMode spikeMode = SpikeMode.getFromName( tag.getString( "SpikeMode" ) );
            this.spikeMode = spikeMode == null ? SpikeTrapBlock.SpikeMode.NORMAL : spikeMode;
        }
    }
